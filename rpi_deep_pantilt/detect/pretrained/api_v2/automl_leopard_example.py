...
class LeopardAutoMLInt8(TFLiteDetectionPostProcessPredictor):
    ...
    def __init__(self,
        ...
        tflite_file=rpi_deep_pantilt_path[0] + '/data/leopard.tflite', # substitute the FULL path to your .tflite file 
        label_file=rpi_deep_pantilt_path[0] + '/data/leopard_label_map.pbtxt', # you only need to change this if adding additional labels (background class is implicitly id:0)
        input_shape=(320, 320), # make sure height, width match metadata.json inputShape
